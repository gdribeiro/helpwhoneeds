...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { description: @donation.description, donationDatte: @donation.donationDatte, value: @donation.value } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { description: @donation.description, donationDatte: @donation.donationDatte, value: @donation.value } }
